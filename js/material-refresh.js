...
;(function($){
    ...
    function touchStart(e){
        ...
        if (e.originalEvent.touches[0]) {
            touchPos.x1 = e.originalEvent.touches[0].pageX;
            touchStartY = touchPos.y1 = e.originalEvent.touches[0].pageY;
        }
    }
    ...
    function touchMove(e){
        ...
        if (touchPos.top > 0 || isShowLoading || !e.originalEvent.touches || e.originalEvent.touches.length !== 1) {
            // Just allow one finger
            return;
        }

        thisTouch = e.originalEvent.touches[0];
